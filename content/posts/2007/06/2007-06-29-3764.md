...
catch: http://image.moongift.jp/intro3/phpCodeGenerator_6102/4_thumb1.png
id: 3764
---
[![](http://image.moongift.jp/intro3/phpCodeGenerator_6102/3_thumb1.png)](http://image.moongift.jp/intro3/phpCodeGenerator_6102/33.png) DBを使った開発であれば必ず出てくるのがマスタメンテナンス画面だ。同じような作りで、毎度作るのが面倒に感じている人も多いだろう。だが、ユーザのためを考えれば必ず必要なのもわかっているはずだ。   
...
[![](http://image.moongift.jp/intro3/phpCodeGenerator_6102/4_thumb1.png)](http://image.moongift.jp/intro3/phpCodeGenerator_6102/43.png) DBに接続し、データベースを選択すると、その中のどのテーブルを利用するか選択する画面になる。全て選択して出力する事も可能だ。終わればテーブルの一覧、データの追加、編集、削除といった操作や検索ができる画面が自動生成される。   
