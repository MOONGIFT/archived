...
catch: http://image.moongift.jp/intro3/RailsRailRoad_757B/5_thumb.png
id: 3777
---
[![](http://image.moongift.jp/intro3/RailsRailRoad_757B/6_thumb.png)](http://image.moongift.jp/intro3/RailsRailRoad_757B/62.png) Ruby on Railsの素晴らしい点の一つに、テーブル間の関係をプログラム中で定義することで、データを自在に取り出せるようになるという事が挙げられる。   
...
[![](http://image.moongift.jp/intro3/RailsRailRoad_757B/5_thumb.png)](http://image.moongift.jp/intro3/RailsRailRoad_757B/52.png) RailRoadを使うと、モデルやコントローラーの関係から、Graphviz向けのdotファイルを生成できる。後はSVGやPNGといった形式への変換が可能だ。   
