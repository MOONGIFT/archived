...
catch: http://image.moongift.jp/intro3/OpenOfficeunoconv_875/10_thumb.png
id: 3953
---
[![](http://image.moongift.jp/intro3/OpenOfficeunoconv_875/11_thumb.png)](http://image.moongift.jp/intro3/OpenOfficeunoconv_875/112.png) OpenOfficeの素晴らしさはやはりここではないだろうか。オフィススイートの代替と言う地位は、現状のシェアを考えるとMS Officeが抜きん出ている。だが、それはクライアントサイドでの話だ。   
...
[![](http://image.moongift.jp/intro3/OpenOfficeunoconv_875/10_thumb.png)](http://image.moongift.jp/intro3/OpenOfficeunoconv_875/102.png) オフィス用ドキュメントをWeb上で作成するソフトウェアも数多く登場している。そこで便利になるのが相互変換を利用したローカルとインターネットとをつなぐ技術だ。OpenOfficeを利用すればそれも容易になるだろう。   
